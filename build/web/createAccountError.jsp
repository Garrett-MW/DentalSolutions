<%-- 
    ...
    Created on : Oct 31, 2024, 3:08:23 PM
    Author     : garrett
--%>
...
<html>
    ...
    <div id="LoginErrorContentContainer">
       ...
       <h3>Account Associated with ID: <%= patId%> Already Exists</h3>
       <a href="createAccount.html"><button id="indexButton">Try Again</button></a>
    </div>
